...
export interface ApiHomepageHomepage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    about: Schema.Attribute.Component<'components.about', false>;
    clients: Schema.Attribute.Component<'components.clients', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPhotographySlugPhotographySlug
  extends Struct.CollectionTypeSchema {
  collectionName: 'photography_slugs';
  info: {
    description: '';
    displayName: 'PhotographySlug';
    pluralName: 'photography-slugs';
    singularName: 'photography-slug';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::photography-slug.photography-slug'
    > &
      Schema.Attribute.Private;
...
export interface ApiVideographySlugVideographySlug
  extends Struct.CollectionTypeSchema {
  collectionName: 'videography_slugs';
  info: {
    description: '';
    displayName: 'VideographySlug';
    pluralName: 'videography-slugs';
    singularName: 'videography-slug';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gallery: Schema.Attribute.Component<'blocks.gallery', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::videography-slug.videography-slug'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::photography-slug.photography-slug': ApiPhotographySlugPhotographySlug;
      'api::photography.photography': ApiPhotographyPhotography;
      'api::videography-slug.videography-slug': ApiVideographySlugVideographySlug;
      'api::videography.videography': ApiVideographyVideography;
